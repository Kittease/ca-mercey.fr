...
const PageButton = ({
  ...
  return (
    <button
      type="button"
      className={cn(
        "group relative flex h-fit w-full cursor-pointer items-center overflow-hidden rounded-xl border bg-stone-800",
    ...
    >
      ...
      <div
        className={cn(
          ...
          "before:absolute before:inset-0 before:z-0 before:bg-linear-to-tr before:from-background/95 before:to-stone-700/90",
